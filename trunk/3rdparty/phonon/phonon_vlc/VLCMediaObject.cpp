...
{
	//MediaPlayer
	p_vlc_media_player = libvlc_media_player_new( p_vlc_instance, p_vlc_exception );
        checkException();
...
void VLCMediaObject::loadMediaInternal( const QString & filename )
{
	...
	p_vlc_media = libvlc_media_new( p_vlc_instance, filename.toAscii(), p_vlc_exception );
	checkException();

	//Create a media player environement
	libvlc_media_player_set_media(p_vlc_media_player, p_vlc_media, p_vlc_exception );
	checkException();
...
void VLCMediaObject::setVLCWidgetId()
{
	...
	//libvlc_media_player_set_drawable(p_vlc_media_player, (libvlc_drawable_t) _videoWidgetId, p_vlc_exception);
	//checkException();

	libvlc_video_set_parent( p_vlc_instance, (libvlc_drawable_t) i_video_widget_id, p_vlc_exception );
	checkException();
}
...
void VLCMediaObject::playInternal()
{
	...
	//Play
	libvlc_media_player_play( p_vlc_media_player, p_vlc_exception );
	checkException();
}

void VLCMediaObject::pause()
{
	libvlc_media_player_pause( p_vlc_media_player, p_vlc_exception );
	checkException();
}

void VLCMediaObject::stop()
{
	libvlc_media_player_stop( p_vlc_media_player, p_vlc_exception );
	checkException();
	//unloadMedia();
}
...
void VLCMediaObject::seekInternal(qint64 milliseconds)
{
	...
	libvlc_media_player_set_time( p_vlc_media_player, milliseconds, p_vlc_exception );
	checkException();
}

QString VLCMediaObject::errorString() const
{
	return libvlc_exception_get_message( p_vlc_exception );
}
...
{
	//MediaPlayer
	p_vlc_media_player_event_manager = libvlc_media_player_event_manager( p_vlc_media_player, p_vlc_exception );
	...
	for (int i = 0; i < nbEvents; i++) {
		libvlc_event_attach(p_vlc_media_discoverer_event_manager, eventsMediaDiscoverer[i], libvlc_callback, this, p_vlc_exception);
	}
	*/
}
...
void VLCMediaObject::libvlc_callback(const libvlc_event_t *p_event, void *p_user_data)
{
	...
	if( p_event->type == libvlc_MediaPlayerTimeChanged )
	{
		...
		if( i_first_time_media_player_time_changed == 15 )
		{
			...
			bool b_seekable = libvlc_media_player_is_seekable( p_vlc_mediaObject->p_vlc_media_player, p_vlc_exception );
			checkException();
			...
			//Video width/height
			int i_width = libvlc_video_get_width( p_vlc_mediaObject->p_vlc_media_player, p_vlc_exception );
			checkException();
			int i_height = libvlc_video_get_height( p_vlc_mediaObject->p_vlc_media_player, p_vlc_exception );
			checkException();
			emit p_vlc_mediaObject->videoWidgetSizeChanged( i_width, i_height);

			//Checks if the file is a video
			bool b_has_video = libvlc_media_player_has_vout( p_vlc_mediaObject->p_vlc_media_player, p_vlc_exception );
			checkException();
	...
	if( p_event->type == libvlc_MediaDurationChanged )
	{
		...
		libvlc_time_t totalTime = libvlc_media_get_duration( p_vlc_mediaObject->p_vlc_media, p_vlc_exception );
		checkException();
...
void VLCMediaObject::updateMetaData()
{
	...
	metaDataMap.insert( QLatin1String( "ARTIST" ),
	                    QString::fromUtf8( libvlc_media_get_meta( p_vlc_media, libvlc_meta_Artist, p_vlc_exception )));
	checkException();
	metaDataMap.insert( QLatin1String( "ALBUM" ),
	                    QString::fromUtf8( libvlc_media_get_meta( p_vlc_media, libvlc_meta_Album, p_vlc_exception )));
	checkException();
	metaDataMap.insert( QLatin1String( "TITLE" ),
                        QString::fromUtf8( libvlc_media_get_meta( p_vlc_media, libvlc_meta_Title, p_vlc_exception )));
	checkException();
	metaDataMap.insert( QLatin1String( "DATE" ),
                        QString::fromUtf8( libvlc_media_get_meta( p_vlc_media, libvlc_meta_Date, p_vlc_exception )));
	checkException();
	metaDataMap.insert( QLatin1String( "GENRE" ),
	                    QString::fromUtf8( libvlc_media_get_meta( p_vlc_media, libvlc_meta_Genre, p_vlc_exception )));
	checkException();
	metaDataMap.insert( QLatin1String( "TRACKNUMBER" ),
	                    QString::fromUtf8( libvlc_media_get_meta( p_vlc_media, libvlc_meta_TrackNumber, p_vlc_exception )));
	checkException();
	metaDataMap.insert( QLatin1String( "DESCRIPTION" ),
	                    QString::fromUtf8( libvlc_media_get_meta( p_vlc_media, libvlc_meta_Description, p_vlc_exception )));
	checkException();
	metaDataMap.insert( QLatin1String( "COPYRIGHT" ),
	                    QString::fromUtf8( libvlc_media_get_meta( p_vlc_media, libvlc_meta_TrackNumber, p_vlc_exception )));
	checkException();
	metaDataMap.insert( QLatin1String( "URL" ),
	                    QString::fromUtf8( libvlc_media_get_meta( p_vlc_media, libvlc_meta_URL, p_vlc_exception )));
	checkException();
	metaDataMap.insert( QLatin1String( "ENCODEDBY" ),
	                    QString::fromUtf8( libvlc_media_get_meta( p_vlc_media, libvlc_meta_EncodedBy, p_vlc_exception )));

	qDebug() << "updateMetaData(): artist:"
	         << libvlc_media_get_meta( p_vlc_media, libvlc_meta_Artist, p_vlc_exception );
    checkException();
    qDebug() << "updateMetaData(): title:"
	         << libvlc_media_get_meta( p_vlc_media, libvlc_meta_Title, p_vlc_exception );
	checkException();
...
{
	libvlc_time_t time = libvlc_media_player_get_time( p_vlc_media_player, p_vlc_exception );
	checkException();
