...
void VLCMediaController::setCurrentChapter( int chapter )
{
    ...
    //libvlc_media_player_set_chapter( p_vlc_media_player, chapter.index(), p_vlc_exception );
    libvlc_media_player_set_chapter( p_vlc_media_player, chapter, p_vlc_exception );
    checkException();
}
